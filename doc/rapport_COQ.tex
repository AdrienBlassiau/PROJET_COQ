...
\coqdocemptyline
\coqdocnoindent
\coqdockw{Theorem} \coqdocvar{occ\_filter\_2} : \coqdockw{\ensuremath{\forall}} (\coqdocvar{P} : \coqdocvar{A} \ensuremath{\rightarrow} \coqdocvar{bool}) (\coqdocvar{a} : \coqdocvar{A}) \coqdocvar{l},
\coqdocnoindent
